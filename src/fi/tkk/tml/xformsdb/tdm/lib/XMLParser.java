...
public class XMLParser extends DefaultHandler {
	 ...
	 */
	public Node parse( String file, NodeFactory aFactory ) throws ParseException, java.io.FileNotFoundException, java.io.IOException {
		factory				= aFactory;
	...
	/** Parse an XML file. Returns a parse tree of the XML file.
	 *  @param inputStream 	Input XML file
	 *  @param aFactory 	Factory for creating nodes in the tree.
	 */
	public Node parse( InputStream inputStream, String encoding, NodeFactory aFactory ) throws ParseException, java.io.FileNotFoundException, java.io.IOException {
		factory				= aFactory;
		//FileReader r		= new FileReader(file);

		try {
  			InputSource is	= new InputSource( new java.io.InputStreamReader( inputStream, encoding ) );
  			//is.setEncoding( "utf-8" );
  			xr.parse( is );
  		} catch ( org.xml.sax.SAXException x ) {
  			throw new ParseException( x.getMessage() );
	...
	public void startDocument() {
		currentNode			= factory.makeNode( new XMLElementNode( "$ROOT$", new AttributesImpl() ) );
	}
	...
	public void startElement( String uri, String name, String qName, Attributes atts ) {
		if ( currentText != null ) {
			currentNode.addChild( factory.makeNode( new XMLTextNode( currentText.toCharArray() )  ) );
		}
