...
public class Writer
    ...
    // PRIVATE VARIABLES
    private String xmlEncoding							= Constants.XML_DEFAULT_ENCODING;
    private String encoding								= Constants.JAVA_DEFAULT_ENCODING;
    ...
    public Writer( OutputStream stream, String encoding ) throws UnsupportedEncodingException {
    	this.setOutput( stream, encoding );
    } // <init>()
    ...
    public void setOutput(OutputStream stream, String encoding)
        ...
        java.io.Writer writer = new OutputStreamWriter(stream, this.encoding);
    ...
    public void startElement(String uri, String local, String raw,
        ...
        if (fElementDepth == 0) {
            ...
            if (!fCanonical) {
                if (fXML11) {
                    fOut.println("<?xml version=\"1.1\" encoding=\"" + this.xmlEncoding + "\"?>");
                }
                else {
                    fOut.println("<?xml version=\"1.0\" encoding=\"" + this.xmlEncoding + "\"?>");
                }
                fOut.flush();
            }
        }
